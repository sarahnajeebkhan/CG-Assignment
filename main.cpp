...
void introScreen()
{
	glClear(GL_COLOR_BUFFER_BIT);
		...
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(-425, 490, 0.0,"BMSIT INSTITUTE OF TECHNOLOGY");
		glColor3f(1.0, 1.0, 1.0);
	...
	displayRasterText(-125, 225, 0.0,"3D ROBOT");
	...
	displayRasterText(-100, 150, 0.0,"created by");
	 ...
	 //displayRasterText(-130, 80, 0.0,"SHOOTERS");
	  ...
	  displayRasterText(-800, -100, 0.0," STUDENT NAME");
	  	glColor3f(1.0, 1.0, 1.0);
	displayRasterText(-800, -200, 0.0,"Sarah Khan");
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(500, -100, 0.0,"Under the Guidance of");
		glColor3f(1.0, 1.0, 1.0);
	displayRasterText(500, -200, 0.0,"Prof Shankar R and Prof Muneshwara MS");
		glColor3f(1.0, 0.0, 0.0);
...
void display(void)
{
 ...
 glLoadName(TEXTID);
 glColor3f(1,1,0);
 DrawTextXY(-2.5,0.2,2.0,0.0015,"1BY19CS216");
 DrawTextXY(-2.5,0.5,2.0,0.0015,"Sarah Khan");
...
int main(int argc, char **argv)
{
  ...
  glutCreateWindow("Sarah's Personal Robot");
  myinit();
